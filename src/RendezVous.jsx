...
const RendezVous = () => {
  ...
  async function save(e) {
    ...
    try {
      await axios.post("http://localhost:8888/rendez-vous/rendezVous/priseRendezVous/souhail", {
        adresse: city,
        reference: reference,
        date: formattedDate,   
      });
        ...
        <form className="RendezVous-form" onSubmit={handleSubmit}>  
          ...
          <LocalizationProvider dateAdapter={AdapterDateFns}>
            ...
            <label htmlFor="Condition Temporelle">Souffrez-vous des conditions suivantes ?</label>
                ...
                {registrationSuccess && (
        <p>Inscription réussie! <a href="http://localhost:8888/rendez-vous/pdf">Go to another page</a></p>
      )}
        </form>
    </div>
